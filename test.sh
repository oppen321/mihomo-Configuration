...
# 生成订阅链接转换后的URL
CONVERTED_URL="https://id9.cc/sub?target=clash&url=${SUBSCRIPTION_URL}&insert=false&emoji=true&list=false&udp=true&tfo=false&scv=false&fdn=false&sort=false&new_name=true"
