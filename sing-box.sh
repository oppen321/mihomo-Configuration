...
case "$ARCH" in
  amd64)
    DEB_URL="https://github.com/SagerNet/sing-box/releases/download/$LATEST_RELEASE/sing-box_${LATEST_RELEASE}_amd64.deb"
    ;;
  arm64)
    DEB_URL="https://github.com/SagerNet/sing-box/releases/download/$LATEST_RELEASE/sing-box_${LATEST_RELEASE}_arm64.deb"
    ;;
  *)
    echo "未支持的架构: $ARCH"
    exit 1
